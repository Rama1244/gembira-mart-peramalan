                            ...
                            Forgot Password
									...
									<form>
										<div class="mb-3">
											...
											<input class="form-control form-control-lg" type="text" name="username" placeholder="Masukkan Email yang telah terdaftar" />
                      <p class="text-danger"><small>*Pesan akan dikirim ke Email yang sudah terdaftar</small></p>
										</div>
