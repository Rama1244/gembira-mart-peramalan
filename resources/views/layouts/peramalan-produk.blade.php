...
<main class="content">
	<div class="container-fluid p-0">
		<div class="mb-3">
			<h1 class="h3 d-inline align-middle">Peramalan Produk</h1>
		</div>
		<div class="row">
			<div class="col-12 col-lg-12">
				<div class="card">
					<div class="card-header">
						<h5 class="card-title mb-0">Hitung Peramalan Produk</h5>
					</div>
					<div class="card-body">
						<form action="{{ route('peramalan-product.store') }}" method="post" enctype="multipart/form-data">
							@csrf
                            <div class="row">
                                <div class="col-sm-6">
            ...
            <div class="row">
                <div class="col-12 col-lg-12">
                    <div class="alert alert-primary" role="alert">
                        Anda memilih barang <strong>{{ $nama_barang }}</strong> dan Nilai Alpha <strong>{{ $alpha }}</strong>
                    </div>
                </div>
            </div>
            <div class="row">
                            ...
                            <table class="table table-hover my-0">
                                ...
                                <tbody>
                                    @php
                                        ...
                                        $id = 0;
                                        @endphp
                                    @foreach ($penjualan_barang as $d => $data)
                                    <tr>
                                        <td>{{ $no }}</td>
                                        <td>{{ $bulan[$id] }}</td>
            ...
            <div class="row">
                <div class="col-12 col-lg-12">
                    <div class="alert alert-success" role="alert">
                        Hasil Peramalan <strong>{{ $nama_barang }}</strong> pada bulan <strong>{{ $hasil_bulan_forcasting }}</strong> adalah <strong>{{ $hasil_forcasting }}</strong>, dengan hasil MAPE <strong>{{ (int)$rata_mape }}%</strong>
                    </div>
                </div>
            </div>
            <div class="row">
